...
from easyrag import create_embeddings_batch  # noqa: E402
from easyrag.utils import get_supabase_client  # noqa: E402
...
async def index_documents_batch(documents: list[dict]):
    ...
    for text, embedding in zip(result.texts_processed, result.embeddings, strict=False):
